...
--
-- Host: localhost    Database: twincities
-- ------------------------------------------------------
...
CREATE TABLE `placesofinterest` (
  `P_ID` int NOT NULL,
  `CityID` int NOT NULL,
  `Stadiums` varchar(45) DEFAULT NULL,
  `Cinemas` varchar(45) DEFAULT NULL,
  `ConcertsHall` varchar(45) DEFAULT NULL,
  `Universities` varchar(45) DEFAULT NULL,
  `Cathedrals` varchar(45) DEFAULT NULL,
  `PublicTransport` varchar(45) DEFAULT NULL,
  `WeatherForecast` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`P_ID`),
...
-- Dump completed on 2020-11-29 12:06:46
